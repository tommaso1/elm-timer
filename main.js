...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var _v1 = _Utils_Tuple2(model.q, model.E);
				if (!_v1.a) {
					if (_v1.b === '') {
...
var $author$project$Main$setMinutes = function (s) {
	var _v0 = $elm$core$String$toInt(s);
	if (!_v0.$) {
		var i = _v0.a;
		return $author$project$Main$SetMinutes(i);
	} else {
		return $author$project$Main$SetMinutes(0);
	}
};
